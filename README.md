...
<font size="7">Research Questions and Motivations:
  As a group we were curious about whether playing a certain position, how often you're get or getting hit, had an connection to commiting more or less crimes. On top of that we wondered if the NFL's inititives had any affect on the behavior of the players off the field. This can be summarized as: 
